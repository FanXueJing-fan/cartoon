  ...
  <div class="page-search">
    <header class="search-header">
      ...
      <div class="header-search">
        ...
        <input v-model='searchVal' class="search-input font-24" type="search" placeholder="漫画名丨作者 ^_^" />
      </div>
     ...
     <template v-if="!searchVal">
      ...
      <section class="search-recommend">
        ...
        <div class="recommend-content font-28">
          ...
          v-for="item in hotWordsList" :key="item.id"
...
export default {
  ...
  methods: {
    ...
    // loacalStorage的结构[keyword, keyword1, ....]
    saveSearch (keyword) {
      if (!keyword) {
        return
      }
      // 判断localStorage是否存在，并取出
